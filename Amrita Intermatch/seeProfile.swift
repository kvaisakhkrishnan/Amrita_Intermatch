    ...
    func informStudent()
    {
        ...
        dispatchQueue.async{
            ...
            let mail = Mail(
                ...
                text: "Hi "+p_name+",\n\nThis is an automated reply to your request for "+pname+" and we are happy to inform you that you are shortlisted.\nCheck the my requests tab in the app to know more!\n\nRegards\nAmrita Intermatch"
            )
...
struct seeProfile_Previews: PreviewProvider {
    static var previews: some View {
        seeProfile(pname: "", email: "", pid: "")
    }
}
